...
(function (root, factory) {
    ...
    iShare.prototype = (function () {
        ...
        var _templates = {
            ...
            _icons = {
                iShare_qq: '<i class="iconfont icon-qq1"></i>',
                iShare_qzone: '<i class="iconfont icon-qunfengqqkongjian"></i>',
                iShare_tencent: '<i class="iconfont icon-tengxunweibo"></i>',
                iShare_weibo: '<i class="iconfont icon-weibo"></i>',
                iShare_wechat: '<i class="iconfont icon-weixin-copy"></i>',
                // iShare_douban: '<i class="iconfont douban" style="vertical-align: -2px;"></i>',
                iShare_renren: '<i class="iconfont icon-renren"></i>',
                // iShare_youdaonote: '<i class="iconfont youdaonote" style="vertical-align: -2px;"></i>',
                iShare_linkedin: '<i class="iconfont icon-linkedin0" style="vertical-align: 1px;"></i>',
                iShare_facebook: '<i class="iconfont icon-facebookfacebook52" style="vertical-align: 1px;"></i>',
                iShare_twitter: '<i class="iconfont icon-twitter0" style="vertical-align: 1px;"></i>',
                iShare_googleplus: '<i class="iconfont icon-google0" style="vertical-align: -2px;"></i>',
                iShare_pinterest: '<i class="iconfont icon-pinterest" style="vertical-align: -2px;"></i>',
                iShare_tumblr: '<i class="iconfont icon-tumblr_F" style="vertical-align: -2px;"></i>'
            };
